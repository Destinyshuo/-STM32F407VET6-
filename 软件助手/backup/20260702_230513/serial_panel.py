...
from PyQt5.QtGui import QColor, QFont, QPainter, QPolygon
...
class TriangleComboBox(QComboBox):
    def paintEvent(self, event) -> None:
        ...
        triangle = QPolygon(
            [
                QPoint(right - 18, center_y - 3),
                QPoint(right - 8, center_y - 3),
                QPoint(right - 13, center_y + 4),
            ]
        )
...
class SerialMatrixPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.connect_button.setMaximumWidth(82)
