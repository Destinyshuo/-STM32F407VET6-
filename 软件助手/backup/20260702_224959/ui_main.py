...
class DashboardPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.user_state_label.setStyleSheet(label_clean_style("color: #35be63; font-size: 10pt;"))
        ...
        self.serial_matrix.setMinimumHeight(392)
        right_column.addWidget(self.serial_matrix)

        left_column.addWidget(self._build_radar_card())
        ...
        self.ai_panel.setMinimumHeight(268)
    ...
    def _build_radar_card(self) -> QFrame:
        ...
        self.air_quality_box.setMinimumHeight(42)
...
class PlantAssistantMainWindow(QMainWindow):
    ...
    def _show_dashboard_page(self) -> None:
        ...
        self._set_window_size(1080, 860)
